...
def test_update_item_from_dict():
    ...
    expected_update_item_response = {
        'Attributes': {'id': {'S': '1'}, 'name': {'S': 'Harry'}, 'bestfriend': {'S': 'Lloyd'}},
        'ConsumedCapacity': {},
        'ItemCollectionMetrics': {}}
    expected_update_item_parameters = {'ExpressionAttributeNames': {'#bestfriend': 'bestfriend'},
    ...
    with Stubber(client) as stubber:
        ...
        attributes = {'bestfriend': 'Lloyd'}
        item = dyn.update_item_from_dict('testtable', {'id': '1'}, attributes, client)
        assert item == {'id': '1', 'name': 'Harry', 'bestfriend': 'Lloyd'}
